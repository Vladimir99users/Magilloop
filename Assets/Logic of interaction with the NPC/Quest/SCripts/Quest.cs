...
namespace Quest
{
    ...
    public class Quest : ScriptableObject
    {
        ...
        public CreateNewNPC WhoIssuedQuestNPC;
        public QuestCompletedEvent OnCompleteQuest;
        public bool IsCompleted {get;private set;}
        public bool QuestIsGive {get;private set;}
        public int ID {get; protected set;}
        public abstract class QuestGoal : ScriptableObject
        {
            [Header("На кого влияет завершение квеста")]
            [SerializeField] private CreateNewNPC _whoNeedsChangeDialog;

            [Header("Отображение и дополнительная логика квеста")]
            ...
            internal void CheckIsNPC(CreateNewNPC _npc) // название переработатЬ!
            {
                if(_whoNeedsChangeDialog is null)
                {
                    _whoNeedsChangeDialog = _npc;
                }
            }
            ...
            {
                Completed = true;
                EventManadger.SendMessageAboutWhatQuestGoalIsCompleted(_whoNeedsChangeDialog);
        ...
        public virtual void InitializationQuest()
        {
            if(!QuestIsGive)
            {
                ...
                foreach (var goal in Goals)
                {
                    ...
                    goal.CheckIsNPC(WhoIssuedQuestNPC);
                }
